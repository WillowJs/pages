...
describe('pages', function() {
	it('should exist', function() {
		expect(Pages).not.to.be.undefined;
	});
	it('should only render the currently visible page', function() {
		var pagesNode1 = utils.renderIntoDocument(
			<Pages page="home">
				<div page="home">Home</div>
				<div page="about">About</div>
				<div page="blog">Blog</div>
				<div page="projects">Projects</div>
			</Pages>
		);
		expect(pagesNode1.getDOMNode().innerHTML).to.equal('Home');

		var pagesNode2 = utils.renderIntoDocument(
			<Pages page="about">
				<div page="home">Home</div>
				<div page="about">About</div>
				<div page="blog">Blog</div>
		...
		expect(pagesNode2.getDOMNode().innerHTML).to.equal('About');

		var pagesNode3 = utils.renderIntoDocument(
			<Pages page="blog">
				<div page="home">Home</div>
				<div page="about">About</div>
				<div page="blog">Blog!</div>
		...
		expect(pagesNode3.getDOMNode().innerHTML).to.equal('Blog!');

		var pagesNode4 = utils.renderIntoDocument(
			<Pages page="projects">
				<div page="home">Home</div>
				<div page="about">About</div>
				<div page="blog">Blog</div>
		...
		expect(pagesNode4.getDOMNode().innerHTML).to.equal('Projects');
	});

	it('should have the ability to set page not found', function() {
		var notFound = <div>We could not find the page you were looking for.</div>;
		var pagesNode = utils.renderIntoDocument(
			<Pages page="test" notFound={notFound}>
				<div page="home">Home</div>
				<div page="about">About</div>
				<div page="blog">Blog</div>
				<div page="projects">Projects</div>
		...
		expect(pagesNode.getDOMNode().innerHTML).to.equal('We could not find the page you were looking for.');
	});

	it('should show the correct default not found page if none is specified', function() {
		var pagesNode = utils.renderIntoDocument(
			<Pages page="test">
				<div page="home">Home</div>
				<div page="about">About</div>
		...
		expect(pagesNode.getDOMNode().innerHTML).to.equal('page not found');
	});
});
